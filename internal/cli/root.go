...
var rootCmd = &cobra.Command{
	...
	Long: `todo is a Unix-style CLI for managing projects, subprojects, and tasks
...
func init() {
	...
	rootCmd.PersistentFlags().String("db", "", "Path to database file (overrides TODO_DB_PATH)")
