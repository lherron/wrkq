...
var dtoSchemaTypes = map[string]reflect.Type{
	...
	"WrkqEnvelopeMemberPage":          dtoType[wrkqapi.WrkqEnvelopeMemberPage](),
	...
	"WrkqEnvelopeMemberPageParams":    dtoType[wrkqapi.EnvelopeMemberPageParams](),
	"WrkqEnvelopeBirthEnvelopeParams": dtoType[wrkqapi.EnvelopeBirthEnvelopeParams](),
	"WrkqEnvelopeBirth":               dtoType[wrkqapi.WrkqEnvelopeBirth](),
	...
	"WrkqLsListViewParams":            dtoType[wrkqapi.LsListViewParams](),
	...
	"WrkqTreeViewParams":              dtoType[wrkqapi.TreeViewParams](),
	...
	"WrkqContainerTimelineViewParams": dtoType[wrkqapi.ContainerTimelineViewParams](),
	...
	"WrkqTimelineProjectEvent":        dtoType[wrkqapi.WrkqTimelineProjectEvent](),
	"WrkqTimelineEntry":               dtoType[wrkqapi.WrkqTimelineEntry](),
	"WrkqContainerTimelineView":       dtoType[wrkqapi.WrkqContainerTimelineView](),
	"WrkqProjectEventPostParams":      dtoType[wrkqapi.ProjectEventPostParams](),
	"WrkqProjectEventGetParams":       dtoType[wrkqapi.ProjectEventGetParams](),
	"WrkqProjectEventTypesViewParams": dtoType[wrkqapi.ProjectEventTypesViewParams](),
	"WrkqProjectEvent":                dtoType[wrkqapi.WrkqProjectEvent](),
	"WrkqProjectEventPostResult":      dtoType[wrkqapi.WrkqProjectEventPostResult](),
	"WrkqProjectEventType":            dtoType[wrkqapi.WrkqProjectEventType](),
	"WrkqProjectEventTypesView":       dtoType[wrkqapi.WrkqProjectEventTypesView](),
