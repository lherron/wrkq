...
-- This represents the complete schema state as of pre-release.
-- Note: schema_migrations table is created by the migration runner itself.

-- Sequence tables for friendly IDs
...
-- Containers table (projects/subprojects)
...
-- Views for hierarchical path resolution
